...
上色：[colorama](https://pypi.org/project/colorama/)
...
np.column_stack(<np_arrayA>,<np_arrayB>) 等价于np.hstack(<np_arrayA>,<np_arrayB>)

np.row_stack((<np_arrayA>,<np_arrayB>) ) 等价于np.vstack(<np_arrayA>,<np_arrayB>)
